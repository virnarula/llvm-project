...
; Function Attrs: convergent mustprogress noinline norecurse nounwind 
define dso_local void @_Z12vectorSquarePKfPfi(ptr noundef %input, ptr noundef %output, i32 noundef %numElements) #0 {
entry:
  ...
  call void @__tb_size_marker_1D(i32 noundef 512) #3
...
!5 = !{ptr @_Z12vectorSquarePKfPfi, !"kernel", i32 1}
