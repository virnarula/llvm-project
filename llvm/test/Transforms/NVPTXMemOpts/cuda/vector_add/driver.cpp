...
int main(void) {
    ...
    CUcontext cuContext;
    CUmodule cuModule;
    CUfunction vectorAddFunction;
    cuInit(0);
    cuDeviceGet(&cuDevice, 0);
    cuCtxCreate(&cuContext, 0, cuDevice);
    cuModuleLoad(&cuModule, "test.fatbin");
    cuModuleGetFunction(&vectorAddFunction, cuModule, "_Z9vectorAddPKfS0_Pfi");
    ...
    // Invoke kernel
    cuLaunchKernel(vectorAddFunction, blocksPerGrid, 1, 1, threadsPerBlock, 1, 1, 0, 0, args, 0);
